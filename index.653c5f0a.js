 ...
 * limitations under the License.
 */
function Ge(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}function Ke(e){const t={};return e.replace(/^\?/,"").split("&").forEach((e=>{if(e){const[n,i]=e.split("=");t[decodeURIComponent(n)]=decodeURIComponent(i)}})),t}function Ye(e){const t=e.indexOf("?");if(!t)return"";const n=e.indexOf("#",t);return e.substring(t,n>0?n:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt="10.4.0";function Gt(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:Ft,automaticDataCollectionEnabled:!1},t),o=i.name;if("string"!=typeof o||!o)throw Vt.create("bad-app-name",{appName:String(o)});if(n||(n=ke()),!n)throw Vt.create("no-options");const r=Ut.get(o);if(r){if($e(n,r.options)&&$e(i,r.config))return r;throw Vt.create("duplicate-app",{appName:o})}const s=new lt(o);for(const e of qt.values())s.addComponent(e);const a=new $t(n,i,s);return Ut.set(o,a),a}function Kt(e=Ft){const t=Ut.get(e);if(!t&&e===Ft&&ke())return Gt();if(!t)throw Vt.create("no-app",{appName:e});return t}function Yt(e,t,n){var i;let o=null!==(i=Wt[e])&&void 0!==i?i:e;n&&(o+=`-${n}`);const r=o.match(/\s|\//),s=t.match(/\s|\//);if(r||s){const e=[`Unable to register library "${o}" with version "${t}":`];return r&&e.push(`library name "${o}" contains illegal characters (whitespace or "/")`),r&&s&&e.push("and"),s&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void zt.warn(e.join(" "))}jt(new rt(`${o}-version`,(()=>({library:o,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{constructor(e){var t,n,i,o,r,s;const a=Ke(Ye(e)),l=null!==(t=a.apiKey)&&void 0!==t?t:null,c=null!==(n=a.oobCode)&&void 0!==n?n:null,h=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);bn(l&&c&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=c,this.continueUrl=null!==(o=a.continueUrl)&&void 0!==o?o:null,this.languageCode=null!==(r=a.languageCode)&&void 0!==r?r:null,this.tenantId=null!==(s=a.tenantId)&&void 0!==s?s:null}static parseLink(e){const t=function(e){const t=Ke(Ye(e)).link,n=t?Ke(Ye(t)).deep_link_id:null,i=Ke(Ye(e)).deep_link_id;return(i?Ke(Ye(i)).link:null)||i||n||t||e}(e);try{return new Di(t)}catch(e){return null}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gi(e,t,n=!1){const i=await jn(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Hi._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const gr=Ce("authIdTokenMaxAge")||300;let yr=null;function vr(e=Kt()){const t=Ht(e,"auth");if(t.isInitialized())return t.getImmediate();const n=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Yt("firebase","10.4.0","app");const br={apiKey:"AIzaSyAc62HmjLcHUIGChJcMCAg71uFk92arqno",authDomain:"js-team-project-filmoteka-gr02.firebaseapp.com",databaseURL:"https://js-team-project-filmoteka-gr02-default-rtdb.firebaseio.com/",projectId:"js-team-project-filmoteka-gr02",storageBucket:"js-team-project-filmoteka-gr02.appspot.com",messagingSenderId:"776953354651",appId:"1:776953354651:web:b78fad8cd465434391e93e"},wr=(Gt(br),"@firebase/database"),xr="1.0.1";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Gs;class Ks extends Xs{static get __EMPTY_NODE(){return Gs}static set __EMPTY_NODE(e){Gs=e}compare(e,t){return Vr(e.name,t.name)}isDefinedOn(e){throw he("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return $s.MIN}maxPost(){return new $s(Hr,Gs)}makePost(e,t){return ce("string"==typeof e,"KeyIndex indexValue must always be a string."),new $s(e,Gs)}toString(){return".key"}}const Ys=new Ks;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Ga(e,t,n,i,o,r){const s=i.filter((e=>e.type===n));s.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw he("Should only compare child_ events.");const i=new $s(t.childName,t.snapshotNode),o=new $s(n.childName,n.snapshotNode);return e.index_.compare(i,o)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),s.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,r);o.forEach((o=>{o.respondsTo(n.type)&&t.push(o.createEvent(i,e.query_))}))}))}function Ka(e,t){return{eventCache:e,serverCache:t}}function Ya(e,t,n,i){return Ka(new $a(t,n,i),e.serverCache)}function Ja(e,t,n,i){return Ka(e.eventCache,new $a(t,n,i))}function Qa(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Za(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Kc(e,t){let n=null;for(let i=0;i<t.length;i++){const o=t[i],r=o.getPath();null===n||Fs(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(o)}n&&e.eventLists_.push(n)}function Yc(e,t,n){Kc(e,n),Qc(e,(e=>Fs(e,t)))}function Jc(e,t,n){Kc(e,n),Qc(e,(e=>Ws(e,t)||Ws(t,e)))}function Qc(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const o=e.eventLists_[i];if(o){t(o.path)?(Zc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Zc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Or&&zr("event: "+n.toString()),es(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
